...
import DotSpinner from "../Common/Spinner/DotSpinner";
 ...
 const HomeChild  = React.memo(({groupData}) => {
        ...
        const fetchOwnerName = useCallback(async () => {
            const name = await commonApiCalls.getNameFromId(GroupOwner);
            setOwner(name);
        }, [GroupOwner]);
        ...
        const getTransactionData = async() => {
            try{
                ...
                console.log("error in  Home child ", e);
            }
